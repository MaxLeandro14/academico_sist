        ...
        <div class="col-md-12">
          <div class="form-group">
            ...
            <select required class="form-control select2_professores" multiple="multiple" name="professores[]">
              ...
              <option value="{{ $disciplina_professor->id }},{{ $disciplina_professor->id_disciplina }},{{ $disciplina_professor->id_professor }}" >{{ $disciplina_professor->codigo_professor }} - {{ $disciplina_professor->nome }} - {{ $disciplina_professor->nome_disciplina }}
              </option>
              @endforeach
            </select>
          </div>
