...
<div class="box-body">
  <div class="row">
    <div class="col-md-6">
      <div class="form-group">
        ...
        <input required type="text" class="form-control" placeholder="Nome do aluno" name="nome_aluno" value="@if(isset($aluno->nome_aluno)){{ $aluno->nome_aluno }}@endif">
      </div>
    </div>
    <div class="col-md-2">
      <div class="form-group">
  ...
  <div class="row">
    <div class="col-md-4">
      ...
      <input required type="text" class="form-control" placeholder="Bairro" name="bairro" value="@if(isset($aluno->bairro)){{ $aluno->bairro }}@endif">
    </div>
    <div class="col-md-5">
    ...
    <div class="col-md-3">
      ...
      <input required type="text" class="form-control" placeholder="Cidade" name="cidade" value="@if(isset($aluno->cidade)){{ $aluno->cidade }}@endif">
    </div>
  </div>
  ...
  <div class="row">
    <div class="col-md-4">
      <label for="">Nome</label>
      <input required type="text" class="form-control" placeholder="Nome do Pai" name="nome_pai" value="@if(isset($aluno->nome_pai)){{ $aluno->nome_pai }}@endif">
    </div>
    <div class="col-md-4">
      <label for="">Profissão</label>
      <input required type="text" class="form-control" placeholder="Profissão" name="profissao_pai" value="@if(isset($aluno->profissao_pai)){{ $aluno->profissao_pai }}@endif">
    </div>
    <div class="col-md-4">
  ...
  <div class="row">
    <div class="col-md-4">
      <label for="">Nome</label>
      <input required type="text" class="form-control" placeholder="Nome da Mãe" name="nome_mae" value="@if(isset($aluno->nome_mae)){{ $aluno->nome_mae }}@endif">
    </div>
    <div class="col-md-4">
      <label for="">Profissão</label>
      <input required type="text" class="form-control" placeholder="Profissão" name="profissao_mae" value="@if(isset($aluno->profissao_mae)){{ $aluno->profissao_mae }}@endif">
    </div>
    <div class="col-md-4">
      <label for="">Telefone Profissão</label>
  ...
  <div id="responsavel_form">
    ...
    <div class="row">
      <div class="col-md-3">
        <label for="">Nome</label>
        <input required type="text" class="form-control" placeholder="Nome do Responsável" name="outro_responsavel_nome" value="@if(isset($aluno->outro_responsavel_nome)){{ $aluno->outro_responsavel_nome }}@endif">
      </div>
      <div class="col-md-2">
        <label for="">Grau de parentesco</label>
        <input required type="text" class="form-control" placeholder="Grau de Parentesco" name="outro_responsavel_parentesco" value="@if(isset($aluno->outro_responsavel_parentesco)){{ $aluno->outro_responsavel_parentesco }}@endif">
      </div>
      <div class="col-md-5">
        <label for="">Endereço</label>
 ...
 @endif
  ...
  <div class="row">
    <div class="col-md-4">
      <label for="">Nome</label>
      <input required type="text" class="form-control" placeholder="Nome da Escola" name="colegio_procedencia" value="@if(isset($aluno->colegio_procedencia)){{ $aluno->colegio_procedencia }}@endif">
    </div>
    <div class="col-md-4">
      <label for="">Cidade</label>
      <input required type="text" class="form-control" placeholder="Cidade" name="cidade_colegio_procedencia" value="@if(isset($aluno->cidade_colegio_procedencia)){{ $aluno->cidade_colegio_procedencia }}@endif">
    </div>
    <div class="col-md-2">
      <label for="">UF</label>
      <input required type="text" class="form-control" placeholder="UF" name="uf_colegio_procedencia" value="@if(isset($aluno->uf_colegio_procedencia)){{ $aluno->uf_colegio_procedencia }}@endif">
    </div>
    <div class="col-md-2">
      <label for="">CEP</label>
  ...
  <div class="row">
    <div class="col-md-4">
      ...
      <select required class="form-control select2_situacao" name="situacao_procedencia">
        <option>@if(isset($aluno->situacao_procedencia)){{ $aluno->situacao_procedencia }}@endif</option>
